...
export default function Homepage() {
  ...
  return (
    <div className="chet-root">
        ...
        <div className="hero__inner container">
          <div className="hero__content">
            ...
            <div className="hero__ctas reveal" data-delay="3">
              <a href="#talks" className="btn btn--primary">
      ...
      {/* ========== WRITING ========== */}
      <section className="writing" id="talks">
        <div className="container">
          <div className="section-head reveal">
            <div className="section-head__left">
              <div className="section-label">04 / Talks</div>
              <h2 className="section-title">
          ...
          <Link href="/talks" className="all-writing reveal">
            All talks {arrow}
          </Link>
        </div>
      </section>
          ...
          <div className="footer__top">
            ...
            <div className="footer__links-wrap">
              ...
              <div className="footer__social">
                <a
                  href="https://www.linkedin.com/in/chetan-mangalwedhe-chet-mann/"
                  aria-label="LinkedIn"
                  target="_blank"
                  rel="noopener noreferrer"
                >
